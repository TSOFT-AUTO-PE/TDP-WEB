...
public class CallerSOAP {
    ...
    private static final String EXCEL_SERVICE = "excel/Service.xlsx";
    ...
    public static void main(String[] args) throws Throwable {
        ...
        getValueTagXML(detailResponse(url, resquest), "fatherFirstName", 0);
        getValueTagXML(detailResponse(url, resquest), "fatherLastName", 0);
        getValueTagXML(detailResponse(url, resquest), "maritalStatus", 0);
        getValueTagXML(detailResponse(url, resquest), "district", 0);
    }
